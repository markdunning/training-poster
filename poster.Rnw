...
\SweaveOpts{concordance=TRUE}
  ...
  \begin{frame}{}
            ...
            \usebeamercolor{title in headline}{\color{crukpink}\textbf{\large{https://github.com/bioinformatics-core-shared-training}}\\[3ex]}
...
\end{block}
  ...
  \end{itemize}
    ...
    \begin{itemize}
    \item{{\color{crukblue}{Simon Bell}}}
    ...
    \item{{\color{crukpink}{Oscar Rueda}}}
    \item{{\color{crukblue}{Shamith Samarajiwa}}}
    ...
    {\color{crukpink}{Seminar room 215}} in Cancer Research Uk Cambridge Institute is block-booked for training two days a month. The course in this room are run in collaboration with the Bioinformatics Training Programme at the Department of Genetics, however priority to attend the course and first notification of courses will be given to CCC members. Participants are expected to bring their own laptops and instructions are provided on how to install the relevant software.\\
    
    
    \begin{itemize}
    \item{\color{crukpink}{Monday 22nd June - Basic Unix}}
    \item{\color{crukblue}{Tuesday 23rd June - Introduction to Statistical Analysis with R Commander}}
    \item{\color{crukpink}{Tuesday 22nd September - Using Genome Browsers}}
    \item{\color{crukblue}{Monday 19th October - Intermediate Statistics}}
    \item{\color{crukpink}{Tuesday 20th October - Intermediate R}}
    \item{\color{crukblue}{Monday 16th November -Introduction to Statistical Analysis with R Commander (for new PhD Students)}}
    \item{\color{crukpink}{Tuesday 17th November -Experimental Design (for new PhD Students)}}
    \item{\color{crukblue}{Monday 30th November - Scientific Figure Design (for new PhD Students)}}
    \item{\color{crukpink}{Monday 14th/Tuesday 15th December - Analysis of Microarray data}}
    \end{itemize}
    \end{block}
...
\end{block}
    ...
    \begin{figure}
        ...
        \begin{oneCol}
    \begin{figure}
        \includegraphics[height=4cm,width=9.7cm]{images/GitHub_Logo.png}
        \end{figure}
        \end{oneCol}

    \begin{oneCol}
    \begin{figure}
    \includegraphics[height=3.50cm,width=4.2cm]{images/Octocat.jpg}
        \end{figure}
        \end{oneCol}
    \end{columns}
    \end{block}
